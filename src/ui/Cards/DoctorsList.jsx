...
const Card = () => {
  ...
  return (
    <div className="group relative w-full max-w-96">
        ...
        <div className="relative p-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="font-semibold text-white">Dr. Prasoon Rawat</h3>
                <p className="text-sm text-slate-400">AIIMS Delhi</p>
              </div>
            </div>
  ...
  <div className="flex items-center gap-3">
    ...
    <div className="flex flex-col gap-3">
      <h5 className="text-sm font-semibold text-slate-400">
        System Enhancements & Resolutions
      </h5>
      <h5 className="text-sm font-semibold text-slate-400">
        Performance Improvements & Updates
      </h5>
      <h5 className="text-sm font-semibold text-slate-400">
        Bug Fixes for Smooth Functionality
      </h5>
      <h5 className="text-sm font-semibold text-slate-400">
      ...
      <h5 className="text-sm font-semibold text-slate-400">
        Cardiologist: Heart Health Expertise
      </h5>
      <h5 className="text-sm font-semibold text-slate-400">
        Orthopedic: Bone & Joint Care
      </h5>
      <h5 className="text-sm font-semibold text-slate-400">
        Dermatologist: Skin & Hair Solutions
      </h5>
      <h5 className="text-sm font-semibold text-slate-400">
...
<div className="flex gap-3 mt-4">
              <button 
              className="group/btn relative flex-1 overflow-hidden rounded-xl  p-px font-medium text-white shadow-[0_1000px_0_0_hsl(0_0%_100%_/_0%)_inset] transition-colors hover:shadow-[0_1000px_0_0_hsl(0_0%_100%_/_2%)_inset]"
              onClick={() => navigate("/appointment")}
              >
                <div className="relative rounded-xl bg-slate-950/50 px-4 py-3 transition-colors group-hover/btn:bg-transparent">
                  <span className="relative flex items-center justify-center gap-2">
                  <svg className="h-5 w-5 text-slate-400 cursor-pointer" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
              </svg>
              View
