...
//   const handleSlotClick = async (startTime) => {
//     setSelectedSlot(startTime);
  
//     if (!selectedDate || !startTime) return;
  
//     try {
//       const token = localStorage.getItem("token"); // adjust if you're using context/auth hook
...
//       if (res.ok) {
//         alert("Appointment requested successfully!"); // Replace with toast if using one
