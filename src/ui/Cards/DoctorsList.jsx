      ...
      <div className="px-4 py-5 sm:px-6">
        <div className="flex items-center">
          <div className="flex-shrink-0">
            <img
              ...
              src={doctor?.profileImage || "https://media.istockphoto.com/id/177373093/photo/indian-male-doctor.jpg?s=612x612&w=0&k=20&c=5FkfKdCYERkAg65cQtdqeO_D0JMv6vrEdPw3mX1Lkfg="}
              alt="Doctor Profile"
            />
          </div>
          <div className="ml-4">
            ...
            <p className="text-sm text-gray-500">
              {doctor?.specialization} {doctor?.clinicName && `| ${doctor.clinicName}`}
            </p>
            <p className="text-sm text-gray-500">
        ...
        <div className="mt-4">
            <p className="text-sm text-gray-700">
              {doctor?.description
                ? doctor.description.split(" ").slice(0, 10).join(" ") + (doctor.description.split(" ").length > 10 ? " ..." : "")
        ...
        <div className="mt-4 bg-emerald-50 px-3 py-2 rounded-md border border-emerald-200">
          <p className="text-sm text-emerald-700 font-medium">
            📍 Location: <span className="font-normal">{doctor?.location || 'Not Provided'}</span>
          </p>
        </div>
        ...
        <div className="mt-4 grid grid-cols-3 gap-4">
          ...
          <div className="text-center">
            <div className="text-lg font-semibold text-emerald-600">
            {doctor?.stories?.length ? `${doctor.stories.length} Stories` : 'No Stories'}
            </div>
