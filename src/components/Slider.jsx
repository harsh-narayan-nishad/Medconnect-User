...
import Qrcodeimg from './QrCodeGenerator'; // assuming it's imported
import Appointment from './AppointmentsSection'; // assuming it's imported
import {authFetch} from '../utils/authFetch'; // your wrapper for authenticated requests
